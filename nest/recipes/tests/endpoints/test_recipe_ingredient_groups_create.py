...
from nest.recipes.endpoints.recipe_ingredient_groups_create import (
...
class TestEndpointRecipeIngredientGroupsCreate:
    ...
    def test_anonymous_request_recipe_ingredient_groups_create_api(
        ...
        service_mock = mocker.patch(
            ...
            f".create_ingredient_item_groups"
        )

        with django_assert_num_queries(2):
            response = client.post(
                f"{self.BASE_ENDPOINT}/{recipe.id}/ingredient-groups/create/",
                data=[],
